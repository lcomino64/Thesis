...
\title{Embedded Systems Super Thesis Project: FPGA RISC-V Softcore Processor for Network Security}

%***YOUR NAME***
%Do not include initials or middle names. Do not include your supervisor(s)' name(s).
\author{Lachlan Comino \\ 45321199}
...
\school{Universty of Queensland, 2024 \\ School of Electrical Engineering and Computer Science, EECS}
...
\input{./Chapter2/Research.tex}
\input{./Chapter3/Stack.tex}
